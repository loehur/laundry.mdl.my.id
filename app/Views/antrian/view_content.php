...
<div class="row mx-0">
  ...
  foreach ($data['data_main'] as $ref => $data_order) {
    ...
    <div data-id_pelanggan='<?= $f17 ?>' id='grid<?= $ref ?>' class='R-<?= $ref ?> cekOperasi col backShow <?= strtoupper($pelanggan) ?> p-0 px-1 mb-2 rounded' style='cursor:pointer;min-width:300px'>
