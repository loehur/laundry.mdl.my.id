  ...
  <div class="row p-1">
    ...
    ?>
      ...
      if ($no_urut == 1) {
        $adaBayar = false;
        $cols++;
        echo "<div data-id_pelanggan='" . $f17 . "' id='grid" . $noref . "' class='" . $id . " R-" . $noref . " col shake_hover backShow " . strtoupper($pelanggan) . " p-0 m-1 rounded' style='cursor:pointer'><div class='bg-white rounded container p-0'>";
